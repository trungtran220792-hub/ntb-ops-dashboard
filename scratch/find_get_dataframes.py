...
if found:
    with open(r'c:\Users\lap4all\Desktop\New folder\scratch\get_dataframes_def.txt', 'w', encoding='utf-8') as f_out:
        for idx, line in results:
            f_out.write(f"L{idx}: {line}\n")
    print("Extracted get_dataframes to scratch/get_dataframes_def.txt")
else:
    print("def get_dataframes not found")
