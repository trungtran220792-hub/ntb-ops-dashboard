...
with open("scratch/scan_steps_1510_2100.txt", "w", encoding="utf-8") as f:
    f.write("\n".join(events))

print(f"Saved {len(events)} events to scratch/scan_steps_1510_2100.txt")
