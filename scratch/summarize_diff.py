def run():
    ...
    out = []
    out.append(f"Total diff sections: {len(sections)}")
    ...
    with open("c:/Users/lap4all/Desktop/New folder/scratch/diff_summary.txt", "w", encoding="utf-8") as f:
        f.write("\n".join(out))

run()
print("Saved summary to scratch/diff_summary.txt")
